...
const NameMaker = () => {
  ...
  return (
    <div>
        ...
        <input type="text" name="" id="" value={newName} placeholder='Name' onChange={(e) => handleChange(e)} />
        {/* we are going get the change event, and use it to change the state, then state will change the input */}
